...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,3,4,2], mat = [[1,4],[2,3]]
...
<pre style="position: relative;"><strong>Input:</strong> arr = [2,8,7,4,1,3,5,6,9], mat = [[3,2,5],[1,4,6],[8,7,9]]
